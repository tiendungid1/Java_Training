...
public class JdkLog implements Log {
  ...
  // The jdkLogger is the instance that does the actual logging for a particular
  ...
  public void error(Message message) {
    if (jdkLogger.isLoggable(Level.SEVERE)) {
      jdkLogger.log(Level.SEVERE, message.getFormattedMessage(), message.getCause());
    }
  }
  ...
  public void warn(Message message) {
    if (jdkLogger.isLoggable(Level.WARNING)) {
      jdkLogger.log(Level.WARNING, message.getFormattedMessage(), message.getCause());
    }
  }
  ...
  public void info(Message message) {
    if (jdkLogger.isLoggable(Level.INFO)) {
      jdkLogger.log(Level.INFO, message.getFormattedMessage(), message.getCause());
    }
  }
  ...
  public void debug(Message message) {
    if (jdkLogger.isLoggable(Level.FINE)) {
      jdkLogger.log(Level.FINE, message.getFormattedMessage(), message.getCause());
    }
  }
  ...
  public void trace(Message message) {
    if (jdkLogger.isLoggable(Level.FINER)) {
      jdkLogger.log(Level.FINER, message.getFormattedMessage(), message.getCause());
    }
  }
}
