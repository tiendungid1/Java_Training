...
/**
 * A convenient wrapper entry class to this logging package. This is used so user do not need to
 * import many classes and methods provided here is easier to use.
 *
 * @author zedeng
 */
public class Logger {
